...
<div class="container">
    ...
    <div class="row">
        <div class="form-group col-md-4">
            <label for="inputTournament">Search by tournament</label>
            <select id="inputTournament" class="form-control">
                <option selected value="">Choose...</option>
                @foreach ($data['tournament'] as $tournament)
                    <option value="{{ $tournament->id_tournament }}">{{ $tournament->name }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group col-md-4">
            <label for="inputGender">Search by gender</label>
        ...
        <div class="form-group col-md-4">
            <label for="inputDate">Search by data:</label>
